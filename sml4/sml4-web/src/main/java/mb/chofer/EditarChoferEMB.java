 ...
 * @author sebastian
 */
@Named(value = "editarChoferEMB")
@RequestScoped
@ManagedBean
public class EditarChoferEMB {
    ...
    static final Logger logger = Logger.getLogger(EditarChoferEMB.class.getName());

    public EditarChoferEMB() {

        logger.setLevel(Level.ALL);
        logger.entering(this.getClass().getName(), "EditarChoferEMB");
        /**/
        ...
        logger.exiting(this.getClass().getName(), "EditarChoferEMB");
    }
