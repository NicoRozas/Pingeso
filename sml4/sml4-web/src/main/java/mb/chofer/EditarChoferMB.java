...
public class EditarChoferMB {
    ...
    public String editarFormulario(){
        ...
        if(response.equals("Exito")){
            ...
            logger.exiting(this.getClass().getName(), "editar", "/chofer/editarChoferResult");
            return "/chofer/editarChoferResult.xhtml?faces-redirect=true";
        }
        logger.exiting(this.getClass().getName(), "editar");
        return "";
    }
